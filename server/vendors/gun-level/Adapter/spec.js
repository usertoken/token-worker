...
describe("An adapter", function () {
  ...
  var adapter = void 0,
      ...
      gun = void 0,
      ctx = void 0;
  var level = (0, _levelup2.default)((0, _encodingDown2.default)((0, _memdown2.default)("test"), {
    valueEncoding: "json"
  }));
  ...
  describe("read", function () {
    ...
    it("should always use json encoding", function () {
      ...
      var _read$calls$0$argumen = (0, _slicedToArray3.default)(read.calls[0].arguments, 2),
    ...
    it("should respond when it finds data", function (done) {
      ...
      adapter.ctx.on("put", function (result) {
        ...
        (0, _expect2.default)(result.put).toEqual(_gun2.default.graph.node(value));
        done();
      });
    ...
    it("should not error out on NotFound results", function () {
      ...
      var _afterRead$calls$0$ar = (0, _slicedToArray3.default)(afterRead.calls[0].arguments, 2),
    ...
    it("should pass the error on unrecognized errors", function () {
      ...
      var _afterRead$calls$0$ar2 = (0, _slicedToArray3.default)(afterRead.calls[0].arguments, 2),
