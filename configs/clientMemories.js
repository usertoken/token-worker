...
var DEV_CLOUD_MEMORIES = ['https://dev-ut-redhat.193b.starter-ca-central-1.openshiftapps.com/gun', 'https://dev-ut-memtwo.193b.starter-ca-central-1.openshiftapps.com/gun'];
var MY_MEMORY = !window || !window.location || !window.location.protocol || !window.location.host ? DEV_CLOUD_MEMORIES : window.location.protocol + '//' + window.location.host + '/gun';
